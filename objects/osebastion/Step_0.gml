...
//The Jake Step code forked into the sebastion. since april 2022

var xDirection = keyboard_check(vk_right) - keyboard_check(vk_left);
var jump = keyboard_check_pressed(ord("Z"));
var dash = keyboard_check_pressed(ord("D")); //ez remove tottally not lazy lol
